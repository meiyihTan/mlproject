...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        '''
        Read in the dataset and split it into train and test set
        '''
        logging.info("Entered the data ingestion method or component")
        try:
            df=pd.read_csv('notebook\data\stud.csv') #here also can be read from mongodb, mySQL  or any database
